...
public class HandwheelController : MonoBehaviour
{
    ...
    [Tooltip("Handwheel waypoint script")][SerializeField]
    private WaypointMover handwheelMover;
    [Tooltip("Objects to turn off when using the handwheel")][SerializeField]
    private List<GameObject> objectsOff= new List<GameObject>();
    [Tooltip("Objects to turn on when using the handwheel")][SerializeField]
