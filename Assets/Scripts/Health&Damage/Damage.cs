...
public class Damage : MonoBehaviour
{
    ...
    // (WG)
    [Tooltip("Whether or not to apply damage on non-trigger collider collisions over time")]
    ...
    /// <summary>
    /// Description:
    /// Deals damage after a specific period of time if the the Collider2D stays within the range of this Collider2D (WG)
    /// Input:
    /// Collision2D collision
    /// Return:
    /// void (no return)
