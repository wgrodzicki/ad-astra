...
public class PlayerController : MonoBehaviour
{
    ...
    [Tooltip("The number of jumps that the player is allowed to make.")]
    ...
    // Gravity change controllers (WG)
    [HideInInspector]
    public bool affectedByExtraGravity = false;
    public int defaultJumpsAllowed = 0;
    public float defaultSpeed = 0.0f;
    public Color defaultColor;

    /// <summary>
    /// Saves default player characteristics in case they need to be restored later (WG)
    /// </summary>
    private void SaveDefaultValues()
    {
        defaultJumpsAllowed = allowedJumps;
        defaultSpeed = movementSpeed;
        defaultColor = this.gameObject.GetComponentInChildren<SpriteRenderer>().color;
    }
}
